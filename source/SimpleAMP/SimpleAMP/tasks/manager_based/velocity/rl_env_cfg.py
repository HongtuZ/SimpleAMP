...
class RewardsCfg:
    ...
    # 基座高度 奖励
    base_height = RewTerm(func=mdp.base_height_exp, weight=0.5, params={"target_height": 0.74, "std": 0.05})
    ...
    feet_distance_y = RewTerm(
        ...
        weight=-2,
        params={"asset_cfg": SceneEntityCfg("robot", body_names=[".*ankle_roll.*"]), "min": 0.2, "max": 0.3},
    )
    ...
    ankle_torque_limit = RewTerm(
        ...
        params={"threshold": 2.0, "asset_cfg": SceneEntityCfg("robot")},  # 扭矩阀值
    )
